...
public class SnsBoardController {
    ...
    */
	...
	public ResponseEntity<?> getImage(@PathVariable String fileLoca, @PathVariable String fileName) {
		...
		HttpHeaders headers = new HttpHeaders(); //응답 해제 객체 생성.
		...
		try {
			...
			e.printStackTrace();
			//static 메서드를 황요하여 ResponseEntity 객체를 생성하는 법.
...
//	@GetMapping("/d/{fileLoca}/{bno}")
//	public void regist(@PathVariable String fileLoca, @PathVariable int bno) {
//		
//	}
